...
class CreatePets implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $pets = $this->getPetsData($customer);
    ...
    public function saveCustomer(): CustomerInterface
    {
        ...
        $customer->setFirstname('Victor')
            ->setLastname('Barcellos')
            ->setEmail('victor@test.com');
    ...
    public function getPetsData(CustomerInterface $customer): array
    {
        return [
            [
                PetInterface::PET_NAME => 'Totó',
                PetInterface::PET_OWNER => $customer->getFirstname(),
                PetInterface::OWNER_TELEPHONE => '15 99999-9999',
                PetInterface::OWNER_ID => $customer->getId(),
            ],
            [
                PetInterface::PET_NAME => 'Caramelo',
                PetInterface::PET_OWNER => $customer->getFirstname(),
                PetInterface::OWNER_TELEPHONE => '15 99999-9999',
                PetInterface::OWNER_ID => $customer->getId(),
            ],
            [
                PetInterface::PET_NAME => 'Lassie',
                PetInterface::PET_OWNER => $customer->getFirstname(),
                PetInterface::OWNER_TELEPHONE => '15 99999-9999',
                PetInterface::OWNER_ID => $customer->getId(),
            ]
